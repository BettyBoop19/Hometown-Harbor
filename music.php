...
<body>
  ...
  <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="mus2.jpg" class="d-block w-100" alt="...">
      </div>
      <div class="carousel-item">
        <img src="mus1.jpg" class="d-block w-100" alt="...">
      </div>
      <div class="carousel-item">
        <img src="mus3.jpg" class="d-block w-100" alt="...">
      </div>
    </div>
  ...
  <main>
    ...
    <section>
      ...
      <div class="product">
        <div class="product-item">
          <img class="product-image" src="mu1.jpg" alt="Product 1">
          <button class="buy-now-button">Buy Now</button>
        </div>
        <div class="product-item">
          <img class="product-image" src="m6.webp" alt="Product 2">
          <button class="buy-now-button">Buy Now</button>
        </div>
        <div class="product-item">
          <img class="product-image" src="m2.jpeg" alt="Product 1">
          <button class="buy-now-button">Buy Now</button>
        </div>
        <div class="product-item">
          <img class="product-image" src="m3.jpg" alt="Product 2">
          <button class="buy-now-button">Buy Now</button>
        </div>
    ...
    <section>
      ...
      <div class="product">
        <div class="product-item">
          <img class="product-image" src="m4.jpeg" alt="Product 3">
      ...
      <button type="submit" class="buy-now-button">Buy Now</button>
        ...
        <div class="product-item">
          <img class="product-image" src="m5.jpeg" alt="Product 4">
          <button class="buy-now-button">Buy Now</button>
        </div>
        <div class="product-item">
          <img class="product-image" src="m7.jpeg" alt="Product 3">
          <button class="buy-now-button">Buy Now</button>
        </div>
        <div class="product-item">
          <img class="product-image" src="m8.jpg" alt="Product 4">
          <button class="buy-now-button">Buy Now</button>
        </div>
