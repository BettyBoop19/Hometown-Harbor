...
<body>
  ...
  <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="handii1.jpeg" class="d-block w-100" alt="...">
      </div>
      <div class="carousel-item">
        <img src="handi5.jpg" class="d-block w-100" alt="...">
      </div>
      <div class="carousel-item">
        <img src="handii2.jpg" class="d-block w-100" alt="...">
      </div>
    </div>
  ...
  <main>
    ...
    <section>
      ...
      <div class="product">
        <div class="product-item">
          <img class="product-image" src="handi1.jpg" alt="Product 1">
          <button class="buy-now-button">Buy Now</button>
        </div>
        <div class="product-item">
          <img class="product-image" src="handi2.jpg" alt="Product 2">
          <button class="buy-now-button">Buy Now</button>
        </div>
        <div class="product-item">
          <img class="product-image" src="handi3.webp" alt="Product 1">
          <button class="buy-now-button">Buy Now</button>
        </div>
        <div class="product-item">
          <img class="product-image" src="handi4.jpg" alt="Product 2">
          <button class="buy-now-button">Buy Now</button>
        </div>
    ...
    <section>
      ...
      <div class="product">
        <div class="product-item">
          <img class="product-image" src="handi5.jpg" alt="Product 3">
          <button class="buy-now-button">Buy Now</button>
        </div>
        <div class="product-item">
          <img class="product-image" src="handi6.jpg" alt="Product 4">
          <button class="buy-now-button">Buy Now</button>
        </div>
        <div class="product-item">
          <img class="product-image" src="handi7.avif" alt="Product 3">
          <button class="buy-now-button">Buy Now</button>
        </div>
        <div class="product-item">
          <img class="product-image" src="handi8.jpg" alt="Product 4">
          <button class="buy-now-button">Buy Now</button>
        </div>
